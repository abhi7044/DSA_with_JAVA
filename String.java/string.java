...
//convert each first letter of each word in uppercase
/*
public class string{
    ...
    public static void main(String[] args) {
       String str = "hi, my name is abhijeet mishra";
...
// }
   public static void main(String[] args) {
       ...
       String lastword = s.substring(s.length() - 5);
   // int lastfive = lastword.length();
...
//how many lowercase vowel occured
